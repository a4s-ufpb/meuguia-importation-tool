...
class MenuFrame(ctk.CTkFrame):
    ...
    def update_attraction_list(self):
        ...
        for i, attraction in enumerate(self.attractions[start_index:end_index]):
            ...
            attraction_frame.grid(row=i, column=0, pady=8, padx=8, sticky='nsew')
